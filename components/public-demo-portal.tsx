...
const controls = [
  "Fictional public display only",
  "No login or user accounts",
  "No persistence or form submission",
  "Read-only and draft-first concepts",
      ...
      <div className={styles.layout}>
        ...
        <div className={styles.content}>
          ...
          <section id="controls" className={styles.controls}>
            <article><p className={styles.eyebrow}>Public demonstration boundaries</p><h2>Clear limitations, stated up front.</h2><ul>{controls.map((control) => <li key={control}>{control}</li>)}</ul></article>
            <article><p className={styles.eyebrow}>Separate future application</p><h2>The authenticated platform remains private.</h2><p>The future client application, identity layer, tenant isolation, secrets, databases, metering, and agent backend would remain in a separately deployed private environment—not this marketing website.</p></article>
          </section>
