    ...
    <main id="main-content" className={styles.page}>
      <section className={styles.hero}>
        <div className="shell">
          ...
          <p className={styles.lead}>These are static, fictional examples. They contain no authentication, persistence, live AI, client connections, or real client data. The future authenticated application remains separate in the private RAW client-platform repository.</p>
        </div>
      </section>
